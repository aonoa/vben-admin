    ...
    schema: [
      ...
      },
      {
        ...
        componentProps: {
          ...
          filterOption: true,
          placeholder: '请选择',
          api: () => getRoleList({ organizationId: organizationId?.() }),
          // 菜单接口转options格式
...
export const gridSchemas: VxeGridProps<any> = {
  ...
  columns: [
    ...
    { field: 'dept', minWidth: 140, title: '部门' },
    {
      field: 'roleNames',
      minWidth: 160,
      slots: { default: 'roles' },
...
export function createUserFormSchemas(
  organizationId?: () => string,
): VbenFormProps {
  return {
    schema: [
...
export const formSchemas = createUserFormSchemas();
